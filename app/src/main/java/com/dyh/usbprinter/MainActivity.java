...
import com.dyh.android.printer.PrinterConfig;
import com.dyh.android.printer.UsbPrintManager;
import com.dyh.android.printer.ui.PrinterManagerActivity;
...
public class MainActivity extends Activity {
    ...
    public void printText(View view) {
        ...
        printerBean.templateInfo = "欢迎使用DYH-USB打印类库\n测试纯文本消息打印\n此打印方式打印无格式内容";
