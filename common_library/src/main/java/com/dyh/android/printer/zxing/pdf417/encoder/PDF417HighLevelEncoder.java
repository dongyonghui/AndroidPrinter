...
package com.dyh.android.printer.zxing.pdf417.encoder;
...
final class PDF417HighLevelEncoder {
   ...
   */
  static String encodeHighLevel(String msg, com.dyh.android.printer.zxing.pdf417.encoder.Compaction compaction, Charset encoding) throws WriterException {
    ...
    if (compaction == com.dyh.android.printer.zxing.pdf417.encoder.Compaction.TEXT) {
      encodeText(msg, p, len, sb, textSubMode);

    } else if (compaction == com.dyh.android.printer.zxing.pdf417.encoder.Compaction.BYTE) {
