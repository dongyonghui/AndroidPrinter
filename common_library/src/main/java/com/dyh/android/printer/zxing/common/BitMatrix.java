...
package com.dyh.android.printer.zxing.common;
...
public final class BitMatrix implements Cloneable {
  ...
  public void xor(BitMatrix mask) {
    ...
    com.dyh.android.printer.zxing.common.BitArray rowArray = new com.dyh.android.printer.zxing.common.BitArray(width / 32 + 1);
   ...
   *         your own row
   */
  public com.dyh.android.printer.zxing.common.BitArray getRow(int y, com.dyh.android.printer.zxing.common.BitArray row) {
    if (row == null || row.getSize() < width) {
      row = new com.dyh.android.printer.zxing.common.BitArray(width);
    } else {
      row.clear();
    }
    int offset = y * rowSize;
   ...
   */
  public void setRow(int y, com.dyh.android.printer.zxing.common.BitArray row) {
  ...
  public void rotate180() {
    ...
    com.dyh.android.printer.zxing.common.BitArray topRow = new com.dyh.android.printer.zxing.common.BitArray(width);
    com.dyh.android.printer.zxing.common.BitArray bottomRow = new BitArray(width);
