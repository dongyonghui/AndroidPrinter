...
public final class Code39Writer extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = com.dyh.android.printer.zxing.oned.Code39Reader.ALPHABET_STRING.indexOf(contents.charAt(i));
      if (indexInString < 0) {
        throw new IllegalArgumentException("Bad contents: " + contents);
      }
      toIntArray(com.dyh.android.printer.zxing.oned.Code39Reader.CHARACTER_ENCODINGS[indexInString], widths);
      for (int width : widths) {
        codeWidth += width;
      }
    }
    boolean[] result = new boolean[codeWidth];
    toIntArray(com.dyh.android.printer.zxing.oned.Code39Reader.CHARACTER_ENCODINGS[39], widths);
