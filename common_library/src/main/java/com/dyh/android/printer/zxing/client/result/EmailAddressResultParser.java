...
public final class EmailAddressResultParser extends ResultParser {
  ...
  @Override
  public com.dyh.android.printer.zxing.client.result.EmailAddressParsedResult parse(Result result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      return new com.dyh.android.printer.zxing.client.result.EmailAddressParsedResult(tos, ccs, bccs, subject, body);
    } else {
